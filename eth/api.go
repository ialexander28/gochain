...
func (api *PublicMinerAPI) SubmitWork(ctx context.Context, nonce types.BlockNonce, solution, digest common.Hash) bool {
	return api.agent.SubmitWork(ctx, nonce, digest, solution)
}
